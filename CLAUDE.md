...
Claude Code plugin wrapping Qwen Code CLI(独立 git 仓库)。**v0.2.0 已发布**:
- GitHub: https://github.com/bbingz/qwen-plugin-cc(public)
- Tags: v0.1.0, v0.1.1, v0.1.2, v0.2.0
- 190 unit + 3 integ tests 全绿(clean env)
...
- **Review archives**:`doc/review-v010-*.md`(v0.1.0 4-way)+ `doc/review-v011-*.md`(v0.1.2 5-way,Kimi 无报告)+ `doc/review-v02-*.md`(v0.2.0 5-way)
